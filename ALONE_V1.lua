...
--------------------------------------------------------------------
local RenUi = library:CreateWindow("ALONE",Color3.fromRGB(255,51,51),"Blox Fruits V1")
--------------------------------------------------------------------
...
local Dropdownz = Main:AddDropdown("Deley FastAttack", {
      "0",
      "0.1",
      "0.15",
      "0.20",
...
Main:AddToggle("Auto Fish Trail (Not work)",_G.AutoFishtrail,function(value)
    _G.AutoFishtrail = value
    StopTween(_G.AutoFishtrail)
end)
...
Dungeon:AddToggle("Auto Next Island",_G.Auto_Next,function(value)
    _G.Auto_Next = value
...
spawn(function()
    pcall(function() 
        while wait() do
            if _G.Auto_Dungeon or _G.Kill then
                if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == true then
                        ...
                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            pcall(function()
                                repeat task.wait()                                    
                                    ...
                                    v.HumanoidRootPart.CanCollide = false
                                    sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                until not _G.Auto_Dungeon or _G.kill or not v.Parent or v.Humanoid.Health <= 0
                            end)
                        end
                    end
                end
...
spawn(function()
    pcall(function()
        while wait() do
            if _G.Auto_Dungeon or _G.Auto_Next then
                if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == true then
...
Misc:AddButton("SetScreen for kaiton",function()
    __Config = {
      ['Inventory'] = {
         ['Fillter'] = {
...
Misc:AddButton("Destroy SetScreen",function()
    __Config = {
      ['Inventory'] = {
         ['Fillter'] = {
...
Misc:AddButton("kaiton FPS",function()
    setfpscap(20)
end)
