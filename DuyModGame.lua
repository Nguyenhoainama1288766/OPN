spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Cảm ơn Bạn Đã Dùng Script Tôi<Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Nhớ Đăng kí Kênh Nha Thank You❤<Color=/>"):Display()
end)
     require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Đây Là Lần Cuối Mình Update🥹<Color=/>"):Display()
end)
----------------------------------------------------------------------------------------------------------------------------------------------
...
LOGO.Image = "rbxassetid://16771492968"
...
wait(1)
LOADING.Text = "Getting Data...Anti"
...
button.BackgroundColor3 = Color3.fromRGB(0, 206, 209) -- Màu xanh nước biển
...
local Window = Fluent:CreateWindow({
    Title = "DUY MOD GAME",
    SubTitle = "Version: 3.5.0 By Duy Mod Game",
    TabWidth = 160,
...
local Tabs = {
    Main = Window:AddTab({ Title = "Tab Item And Sea Events", Icon = "" }),
    ...
    Fruit = Window:AddTab({ Title = "Tab Fruits And Esp", Icon = "" }),
    Raid = Window:AddTab({ Title = "Tab Raid", Icon = "" }),
    Race = Window:AddTab({ Title = "Tab Race V4", Icon = "" }),
    iop = Window:AddTab({ Title = "Tab Race V4", Icon = "" }),
...
ImageButton.Image = "rbxassetid://16771492968"
...
local MiscFarm = Tabs.Main:AddSection("Random Xương")
...
local boss = Tabs.Main:AddSection("Farm Boss")
    ...
    local ToggleMaterial = Tabs.Main:AddToggle("ToggleMaterial", {
        Title = "Tự Động Farm Nguyên Liệu",
        Description = "", 
        Default = false })
    ...
    spawn(function()
      ...
      local ToggleCollectAzure = Tabs.Main:AddToggle("ToggleCollectAzure", {Title = "Tự Động Nhặt lửa Linh Hồn",Description = "", Default = false })
...
if Third_Sea then
    ...
    local ToggleSailBoat = Tabs.Main:AddToggle("ToggleSailBoat", {Title = "Tự Động Mua Thuyền + Ngồi Vào",Description = "", Default = false })
    ...
    local ToggleTerrorshark = Tabs.Main:AddToggle("ToggleTerrorshark", {Title = "Tự Động Đánh Terrorshark",Description = "", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.Main:AddToggle("TogglePiranha", {Title = "Tự Động Đánh Piranha",Description = "", Default = false })
     ...
     local ToggleShark = Tabs.Main:AddToggle("ToggleShark", {Title = "Tự Động Đánh Shark",Description = "", Default = false })
    ...
    local ToggleFishCrew = Tabs.Main:AddToggle("ToggleFishCrew", {Title = "Tự Động Đánh Fish Crew",Description = "", Default = false })
    ...
    local ToggleShip = Tabs.Main:AddToggle("ToggleShip", {Title = "Tự Động Đánh Thuyền Hải Tặc",Description = "", Default = false })
...
while wait() do
    ...
    local ToggleGhostShip = Tabs.Main:AddToggle("ToggleGhostShip", {Title = "Tự Động Đánh Thuyền Ma",Description = "",Default = false })
...
spawn(function()
    ...
    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Tự Động Đánh Boss Elite",Description = "", Default = false })
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "Tự Động Treo ×Đánh Thủy Quái",Description = "", Default = false })
...
ToggleAutoW:OnChanged(function(Value)
 ...
 spawn(function()
    ...
    Tabs.Main:AddButton({
        Title = "Tự Động Bay Đến Đảo Bí Ẩn",
        Description = "",
        Callback = function()
            TweenMirage()
        end
    ...
    Tabs.Main:AddButton({
        Title = "Tự Động Bay đến Chỗ Cao Nhất",
        Description = "",
        Callback = function()
            TwenetoHighestPoint()
        end
    ...
    function getHighestPoint()
        ...
        for r, v in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v:IsA("MeshPart") then
                if v.MeshId == "rbxassetid://16771492968" then
                    return v
                end
            end
        end
...
local ToggleTweenGear = Tabs.Main:AddToggle("ToggleTweenGear", {Title = "Tự Động Nhặt Bánh Răng",Description = "", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Main:AddToggle("Togglelockmoon", {Title = "Tự Động Nhìn Trăng ×Bật Tộc",Description = "", Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "Tự Động Treo Đảo Bí Ẩn",Description = "", Default = false })
ToggleMirage:OnChanged(function(Value)
 ...
 local AutoW = Tabs.Main:AddToggle("AutoW", {Title = "Tự Động Nhấn Phím W",Description = "", Default = false })
...
if Third_Sea then
    local ToggleHallow = Tabs.Main:AddToggle("ToggleHallow", {Title = "Tự Động Lấy Lưỡi Hái Bóng Tối",Description = "", Default = false })
	...
	spawn(function()
           ...
           local ToggleYama = Tabs.Main:AddToggle("ToggleYama", {Title = "Tự Động Lấy kiếm Yama",Description = "", Default = false })
        ...
        local ToggleTushita = Tabs.Main:AddToggle("ToggleTushita", {Title = "Tự Động Lấy Kiếm Tushita",Description = "", Default = false })
        ...
        Options.ToggleTushita:SetValue(false)
           spawn(function()
                   ...
                   local ToggleHoly = Tabs.Main:AddToggle("ToggleHoly", {Title = "Tự Động Thắp Sáng Đuốc Lấy Tushita",Description = "", Default = false })
...
if Second_Sea then
        ...
        if Third_Sea then
    local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "Tự Động Đánh Katakuri V2 (Cần Triệu Hồi)",Description = "", Default = false })
...
if Second_Sea or Third_Sea then
    local ToggleHakiColor = Tabs.Main:AddToggle("ToggleHakiColor", {Title = "Tự Động Mua Haki Màu",Description = "",Default = false })
...
while wait() do
    ...
    local Kitsune = Tabs.iop:AddParagraph({
    ...
    local FrozenIsland = Tabs.iop:AddParagraph({
    ...
    local FM = Tabs.iop:AddParagraph({
        Title = "Moon",
        Content = ""
    })
    ...
    local Input = Tabs.iop:AddInput("Input", {
        Title = "Job Id",
        Default = "",
	...
	Callback = function()
		...
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				...
				huhu.Image = "rbxassetid://16771492968"
...
local SettingFarm = Tabs.Setting:AddSection("Farming")
    ...
    local ToggleBringMob = Tabs.Setting:AddToggle("ToggleBringMob", {Title = "Gom Quái[Pro]",Description = "", Default = true })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Ẩn Dame Farm Quái",Description = "", Default = true })
...
local ToggleRemoveNotify = Tabs.Setting:AddToggle("ToggleRemoveNotify", {Title = "Xoá Thông báo",Description = "", Default = false })
...
local ToggleRejoin = Tabs.Setting:AddToggle("ToggleRejoin", {Title = "Tự động vào lại khi bị văng", Description = "",Default = true })
...
spawn(function()
    ...
    local ToggleWhite = Tabs.Setting:AddToggle("ToggleWhite", {Title = "Màn hình Trắng (Fix Lag)",Description = "", Default = false })
