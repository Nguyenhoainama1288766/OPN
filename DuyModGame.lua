...
local Tabs = {
    ...
    Sea = Window:AddTab({ Title = "Tab Sea Events", Icon = "" }),
...
local ToggleCollectAzure = Tabs.Sea:AddToggle("ToggleCollectAzure", {Title = "Tự Động Nhặt lửa Linh Hồn",Description = "", Default = false })
...
local ToggleSailBoat = Tabs.Sea:AddToggle("ToggleSailBoat", {Title = "Tự Động Mua Thuyền + Ngồi Vào",Description = "", Default = false })
...
local ToggleTerrorshark = Tabs.Sea:AddToggle("ToggleTerrorshark", {Title = "Tự Động Đánh Terrorshark",Description = "", Default = false })
...
local ToggleFishCrew = Tabs.Sea:AddToggle("ToggleFishCrew", {Title = "Tự Động Đánh Fish Crew",Description = "", Default = false })
...
local ToggleShip = Tabs.Sea:AddToggle("ToggleShip", {Title = "Tự Động Đánh Thuyền Hải Tặc",Description = "", Default = false })
...
local ToggleGhostShip = Tabs.Sea:AddToggle("ToggleGhostShip", {Title = "Tự Động Đánh Thuyền Ma",Description = "",Default = false })
...
local ToggleSeaBeAst = Tabs.Sea:AddToggle("ToggleSeaBeAst", {Title = "Tự Động Treo × Đánh Thủy Quái",Description = "", Default = false })
...
local ToggleAutoW = Tabs.Sea:AddToggle("ToggleAutoW", {Title = "Tự Động Lái Thuyền",Description = "", Default = false })
