...
local Window = Fluent:CreateWindow({
    Title = "DUY MOD GAME",
    SubTitle = "Version: 2.5.0 By Duy Mod Game",
    TabWidth = 160,
...
local Tabs = {
    Main = Window:AddTab({ Title = "Tab Farming And Items", Icon = "" }),
    ...
    Island = Window:AddTab({ Title = "Tab Status Sever", Icon = "" }),
...
spawn(function()
    ...
    local Kitsune = Tabs.Island:AddParagraph({
    ...
    local FrozenIsland = Tabs.Island:AddParagraph({
    ...
    local FM = Tabs.Island:AddParagraph({
        Title = "Moon",
        Content = ""
    })
    ...
    local Input = Tabs.Island:AddInput("Input", {
        Title = "Job Id",
        Default = "",
    ...
    local Toggle = Tabs.Island:AddToggle("MyToggle", {Title = "Spam Join Job Id", Default = false })
...
local Mastery = Tabs.Race:AddSection("Luyện Tộc V4")
