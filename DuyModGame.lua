...
local Window = Fluent:CreateWindow({
    Title = "DUY MOD GAME",
    SubTitle = "Version: 4.0.0 By Duy Mod Game",
    TabWidth = 160,
...
Tabs.Main:AddButton({
    ...
    Callback = function()
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Nguyenhoainama1288766/byDuyModGame/main/chetsfram.lua"))()
    end
})
...
spawn(function()
    pcall(function()
      ...
      local ToggleCollectAzure = Tabs.Main:AddToggle("ToggleCollectAzure", {Title = "Collect Azure Ambers",Description = "Nhặt Lửa Linh Hồn", Default = false })
...
spawn(function()
    ...
    local AutoElite = Tabs.Main:AddSection("Boss Elite")
