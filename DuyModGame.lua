...
function InfAbility()
    if _G.SpeedHack then
        if not game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility") then
            ...
            inf.Texture = "rbxassetid://16771492968"
...
Tabs.Visual:AddButton({
	Title = "Rain Fruit",
	Description = "Fake Fruit",
	Callback = function()
        for i, v in pairs(game:GetObjects("rbxassetid://16771492968")[1]:GetChildren()) do
...
warn("Duy Mod Game Loading Completed !!")
