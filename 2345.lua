...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://16601446273"
...
ImageButton1.Image = "rbxassetid://16601446273" -- ảnh button ở ngoài --
...
-- để hình to to trước ui
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageLabel.Image = "rbxassetid://16601446273"
...
---------------------------------- Các Tab
local Library = Update:Window("Hiru Hub","",Enum.KeyCode.RightControl);
...
local T = Library:AddTab("Dịch chuyển","")
...
Dis:AddSeperator("Zalo")


   Dis:AddLabel("Zalo Hiru Hub")

Dis:AddButton("Copy Link", function()
setclipboard("https://zalo.me/g/hudugs462") 
end)

Dis:AddLabel("Zalo Cày Thuê")
Dis:AddButton("Copy Link Zalo", function()
setclipboard("https://zalo.me/g/ucukan565") 
end)

Dis:AddButton("Copy Link Zalo Mua Source", function()
setclipboard("https://zalo.me/g/foqpqm592") 
end)

Dis:AddSeperator("Hỗ Trợ")

Dis:AddLabel("Hỗ trợ cho PC/Mobile")
Dis:AddLabel("SCRIPT HIRU HUB UPDATE")
...
local NotiFrame = Instance.new("Frame")
	...
	function DiscordLib:Notification(text,text2,delays,logo)
		...
		imagenoti.Image = "rbxassetid://16601446273"..tostring(logo)
...
RaceV4:AddToggle("Kill Player After Trial v4!",false,function(value)
...
Troll:AddButton("Hiru Hub! Bành Trướng Lãnh Địa",function()
...
wait(1)
local ID =16601446273 --Này Là Id Ảnh Nha Ní :>>>
