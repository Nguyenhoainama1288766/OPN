...
local Window = Fluent:CreateWindow({
    Title = "Hiru Hub",
    SubTitle = "Version: 4.5.0 By Hiru Hub",
    TabWidth = 160,
...
ImageButton.Image = "rbxassetid://16601446273"
...
local MiscFarm = Tabs.Main:AddSection("Farm Xương")
...
local StatusBone = Tabs.Main:AddParagraph({
	...
	spawn(function()
		pcall(function()
			while wait() do
				StatusBone:SetDesc("Farm Xương : "..tostring(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Check").." Xương"))
			end
		end)
	end)
...
local ToggleRandomBone = Tabs.Main:AddToggle("ToggleRandomBone", {Title = "Đổi xương",Description = "", Default = false })
...
local MiscFarm = Tabs.Main:AddSection("Farm Katakuri")
local Mob_Kill_Cake_Prince = Tabs.Main:AddParagraph({
    Title = "Check Katakuri",
    Content = ""
})
	...
	while wait() do
		pcall(function()
			if string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88 then
				Mob_Kill_Cake_Prince:SetDesc("Giết : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,41).."")
			elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87 then
				Mob_Kill_Cake_Prince:SetDesc("Giết : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,40).."")
			elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
				Mob_Kill_Cake_Prince:SetDesc("Giết : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,39).." ")
			else
				Mob_Kill_Cake_Prince:SetDesc("Katakuri : Có")
			end
		end)
	end
end)
    ...
    function getHighestPoint()
        ...
        for r, v in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v:IsA("MeshPart") then
                if v.MeshId == "rbxassetid://16601446273" then
                    return v
                end
            end
        end
...
local ToggleAutotrial = Tabs.Race:AddToggle("ToggleAutotrial", {Title = "Tự Động hoàn thành ải",Description = "", Default = false })
	...
	Callback = function()
		...
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				...
				huhu.Image = "rbxassetid://16601446273"
