...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> WELECOM TO HIRU HUB<Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Blue>ĐĂNG KÝ KÊNH THANK YOU<Color=/>"):Display()
end)
...
local Window = Fluent:CreateWindow({
    Title = "Hiru Hub",
    SubTitle = "Version 4.0.0 By Hiru Hub",
    TabWidth = 160,
...
local Tabs = {
    ...
    Visual = Window:AddTab({ Title = "Tab Visual", Icon = "scan-face" }),
...
if Third_Sea then
local ToggleChest = Tabs.Main:AddButton({
    Title = "Auto Chest",
...
Tabs.Visual:AddButton({
	...
	Description = "Fake",
	Callback = function()
        for i, v in pairs(game:GetObjects("rbxassetid://16601446273")[1]:GetChildren()) do
...
local LockMoonToggle = Tabs.Race:AddToggle("LockMoon_Toggle", {Title = "Khoá nhìn vào moon", Default = false })
