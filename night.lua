...
spawn(function() 
    ...
    wait(.3)
    require(game.ReplicatedStorage.Notification).new("<Color=Green>Welcome To Hiru Hub<Color=/>"):Display()
    wait(.2)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>SCRIPT ANTI CHEAT<Color=/>"):Display()
    wait(.3)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Channel : HIRU HUB<Color=/>"):Display()
    wait(.4)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Discord : https://zalo.me/g/hudugs462<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Green>! DestroyX and T... and House Of Blance is the HIRU HUB <Color=/>"):Display()
end)
...
local Window = OrionLib:MakeWindow({
    Name = "Hiru Hub", 
    HidePremium = false,
    IntroText = "Hiru Hub Bro", 
    SaveConfig = true, 
    ConfigFolder = "Hiru Hub"
})
...
function Notify(Hiri, Mi)
    OrionLib:MakeNotification({
        Name = "[Hiru Hub]",
        Content = Hiri,
        Image = "rbxassetid://16601446273",
        Time = Mi
    })
end

local I = Window:MakeTab({Name = "Info", Icon = "rbxassetid://16601446273", PremiumOnly = false })
local G = Window:MakeTab({Name = "General", Icon = "rbxassetid://16601446273", PremiumOnly = false })
local ST = Window:MakeTab({Name = "Settings", Icon = "rbxassetid://16601446273", PremiumOnly = false })
local IQ = Window:MakeTab({Name = "Item & Quest", Icon = "rbxassetid://16601446273", PremiumOnly = false })
local LC = Window:MakeTab({Name = "LocalPlayer", Icon = "rbxassetid://16601446273", PremiumOnly = false })
local RD = Window:MakeTab({Name = "Raid & Devil Fruit", Icon = "rbxassetid://16601446273", PremiumOnly = false })
local SV = Window:MakeTab({Name = "Status and Servers", Icon = "rbxassetid://16601446273", PremiumOnly = false })
local RC = Window:MakeTab({Name = "Upgrated Race", Icon = "rbxassetid://16601446273", PremiumOnly = false })
local SE = Window:MakeTab({Name = "Sea Event", Icon = "rbxassetid://16601446273", PremiumOnly = false })
...
I:AddLabel("ANTI VIP")
I:AddLabel("HIRU HUB BY NGUYEN VU DUY")
I:AddLabel("HIRU HUB : House Of Blance")
