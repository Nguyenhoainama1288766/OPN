...
MODILEMAGE.Image = "rbxassetid://16601446273"
...
MODILEGUISOMEXHUB.TextSize = 25.000
...
function Update:Window(text,logo,keybind)
	...
	Hub.Text = "               | Premium"
	Hub.TextColor3 = Color3.fromRGB(0,187,255)
	Hub.TextSize = 17.000
	Hub.TextXAlignment = Enum.TextXAlignment.Left

local version = game:HttpGet("https://raw.githubusercontent.com/accountnop/magmaisgay/main/version")
local ver = Instance.new("TextLabel")
	ver.Name = "ver"
	ver.Parent = Top
	ver.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	ver.BackgroundTransparency = 1.000
	ver.Position = UDim2.new(0.697561002, 0, 0, 0)
	ver.Size = UDim2.new(0, 81, 0, 27)
	ver.Font = Enum.Font.RobotoMono
	...
	ver1.Position = UDim2.new(0.497561002, 0, 0, 0)
	ver1.Size = UDim2.new(0, 81, 0, 27)
	ver1.Font = Enum.Font.RobotoMono
	ver1.Text = "N/A"
	...
	function uitab:Tab(text,icon)
		...
		function main:Button(text,callback)
			...
			Button.BackgroundColor3 = Color3.fromRGB(0,187,255)
			...
			TextBtn.BackgroundColor3 = Color3.fromRGB(0,187,255)
		...
		function main:Toggle(text,config,callback)
			...
			Toggle.BackgroundColor3 = Color3.fromRGB(0,187,255)
...
account_circle.Image = "rbxassetid://16601446273"
...
account_circle.ImageRectSize = Vector2.new(36, 36)
			...
			Circle.BackgroundColor3 = Color3.fromRGB(0,187,255)
			...
			Button.MouseButton1Click:Connect(function()
				if toggled == false then
					...
					TweenService:Create(
						Circle,
						TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
						{BackgroundColor3 = Color3.fromRGB( 0,187,255)}
					):Play()
				else
					toggled = false
		...
		function main:Dropdown(text,option,callback)
			...
			DropImage.Image = "rbxassetid://16601446273"
...
person.ZIndex = 2
person.Image = "rbxassetid://16601446273"
...
person.ImageRectSize = Vector2.new(36, 36)
		...
		function main:Slider(text,min,max,set,callback)
			...
			Slider.BackgroundColor3 = Color3.fromRGB(0,187,255)
			...
			HAHA.Name = "HAHA"
			HAHA.Parent = sliderr
			HAHA.BackgroundColor3 = Color3.fromRGB(0,187,255)
			...
			bar1.Name = "bar1"
			bar1.Parent = bar
			bar1.BackgroundColor3 = Color3.fromRGB(0,187,255)
			...
			slidervalue.BackgroundColor3 = Color3.fromRGB(0,187,255)
		...
		function main:Textbox(text,disappear,callback)
			...
			Textbox.BackgroundColor3 = Color3.fromRGB(0,187,255)
		...
		function main:Seperator(text)
			...
			Seperator.BackgroundColor3 = Color3.fromRGB(0,187,255)
			Seperator.BackgroundTransparency = 1.000
			Seperator.Size = UDim2.new(0, 470, 0, 20)
			
			Sep1.Name = "Sep1"
			Sep1.Parent = Seperator
			Sep1.BackgroundColor3 = Color3.fromRGB(0,187,255)
			...
			Sep3.BackgroundColor3 = Color3.fromRGB(0,187,255)
		...
		function main:Line()
			...
			Linee.BackgroundColor3 = Color3.fromRGB(0,187,255)
			...
			Line.Name = "Line"
			Line.Parent = Linee
			Line.BackgroundColor3 = Color3.fromRGB(0,187,255)
...
-------------------------------------------------------------------------------------------------------------------------------------------------
--Mainn
local Library = Update:Window("Hiru Hub","rbxassetid://",Enum.KeyCode.RightControl);
Main = Library:Tab("Chính",7072717697)
M = Library:Tab("Vật Phẩm",7072706351)
Ss = Library:Tab("Chỉ Số",7072706318)
RaceV4 = Library:Tab("Tộc V4",7040410130)
P = Library:Tab("Người Chơi",7072724538)
T = Library:Tab("Di Chuyển",7072724538)
R = Library:Tab("Tập Kích",6035190846)
S = Library:Tab("Cửa Hàng",7044284832)
D = Library:Tab("Trái Ác Quỷ",7072715646)
Misc = Library:Tab("Khác + Esp",4483362748)
Setting = Library:Tab("Cài Đặt",7044233235)
-----------------------------------------------------------------------------------------------------------------------------------------------------
--Setting
    Setting:Toggle("Di chuyển Reset",BypassTP,function(value)
        BypassTP = value
    end)
    
       Setting:Toggle("Bật tộc v4",false,function(value)
...
while wait(.1) do
    ...
    Setting:Toggle("Gom quái",true,function(Mag)
        _G.BringMonster = Mag
        end)
        spawn(function()
            while task.wait() do
    ...
    Setting:Toggle("Bật haki",true,function(value)
    _G.AUTOHAKI = value
    end)
    spawn(function()
        while wait(.1) do
    ...
    Setting:Toggle("Xoá thông báo",false,function(NamfonGay)
    ...
    spawn(function()
        ...
        spawn(function()
          ...
          if _G.WhiteScreen then
            ...
            Setting:Toggle("Màn hình treo game",_G.WhiteScreen,function(value)
    ...
    elseif _G.WhiteScreen == false then
        ...
        Setting:Seperator("Hướng Cày")
    
        PosX = 0
        Setting:Slider("Pos X",0,60,0,function(value)
        PosX = value
        end)
    
        PosY = 30
        Setting:Slider("Pos Y",0,60,30,function(value)
        PosY = value
        end)
    
        PosZ = 0
        Setting:Slider("Pos Z",0,60,0,function(value)
        PosZ = value
        end)
        
    
        Setting:Seperator("Kĩ năng thông thạo")
...
task.spawn(function()
   ...
   Main:Seperator("Farm Level")

    Main:Toggle("Cày cấp",_G.AutoFarm,function(value)
        _G.AutoFarm = value
...
Main:Toggle("Cày rương | An toàn",false,function(value)
 AutoFarmChest = value
...
Main:Toggle("Cày Rương | Dễ kick",false,function(vu)
	_G.ChestBypass = vu
end)
...
if _G.ChestBypass then
    ...
    Main:Button("Đến đảo tư lệnh bột",function()
        if BypassTP then
    ...
    Main:Toggle("Cày tư lệnh bột",_G.AutoDoughtBoss,function(value)
    ...
    Main:Toggle("Cày hoàng tử bột v2", _G.Autodoughking,function(value)
         _G.Autodoughking = value
        StopTween( _G.Autodoughking)
    end)
    
    Main:Toggle("Cày hoàng tử bột v2 HOP", _G.AutodoughkingHop,function(value)
    ...
    local BoneFarm = Main:Toggle("Cày xương",_G.Auto_Bone,function(value)
        _G.Auto_Bone = value
    ...
    Main:Toggle("Đổi xương",_G.Auto_Random_Bone,function(value)
...
Main:Toggle("Cày thông thạo trái",_G.AutoFarmFruitMastery,function(value)
...
Main:Toggle("Cày thông thạo súng",_G.AutoFarmGunMastery,function(value)
...
_G.Kill_At = 35
Main:Slider("Máu quái",1,100,35,function(value)
    _G.Kill_At = value
end)
...
local BossName = Main:Dropdown("Chọn Boss", bossCheck, function(value)
    _G.SelectBoss = value
end)

Main:Button("Làm mới", function()
BossName:Clear()
wait(0.1)
for i, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
    ...
    Main:Toggle("Cày boss",_G.AutoFarmBoss,function(value)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    ...
    Main:Toggle("Cày tất cả boss",_G.AutoAllBoss,function(value)
        _G.AutoAllBoss = value
        StopTween(_G.AutoAllBoss)
    end)
    
    Main:Toggle("Nhận nhiệm vụ boss",false,function(value)
...
Main:Toggle("Tp đến đảo kitsune",false,function(v)
    _G.TweenToKitsune = v
end)
spawn(function()
    local kitsuneIsland
...
Main:Toggle("Nhặt Hồn",false,function(v)
    _G.CollectAzure = v
end)
spawn(function()
    while wait() do
...
Main:Seperator("Sự kiện biển")
Main:Toggle("Đánh terorshark",false,function(v)
...
spawn(function()
 ...
 Main:Toggle("Đánh Piranha",false,function(v)
    _G.farmpiranya = v
end)
spawn(function()
    while wait() do
 ...
 Main:Toggle("Đánh cá",false,function(v)
    _G.AutoShark = v
end)
spawn(function()
    while wait() do
...
Main:Toggle("Đánh cá Crew",false,function(v)
    _G.AutoFishCrew = v
end)
spawn(function()
    while wait() do
...
--Items
if World1 then
    M:Toggle("Qua sea 2",_G.AutoSecondSea,function(value)
...
if World2 then
    ...
    M:Toggle("Qua Sea 3",_G.AutoThirdSea,function(value)
...
if World2 then
    ...
    M:Toggle("Đánh nhà máy",_G.AutoFactory,function(value)
...
M:Toggle("Đến đảo kì bí",_G.AutoMysticIsland,function(value)
    ...
    spawn(function()
        ...
        M:Seperator("Đến Npc bán trái vip", function()
            TweenNpc()
            end)
...
M:Toggle("Treo đảo kì bí",_G.dao,function(state)
if state then
    _G.dao = true
else
    _G.dao = false
...
M:Toggle("Đến bánh răng",_G.TweenMGear,function(value)
_G.TweenMGear = value
...
M:Seperator("Lấy cận chiến")
M:Toggle("Lấy Superhuman",_G.AutoSuperhuman,function(value)
...
M:Toggle("Lấy DeathStep",_G.AutoDeathStep,function(value)
...
M:Toggle("Lấy Sharkman Karate",_G.AutoSharkman,function(value)
...
M:Toggle("Lấy Electric Claw",_G.AutoElectricClaw,function(value)
...
M:Toggle("Lấy Dragon Talon",_G.AutoDragonTalon,function(value)
...
M:Toggle("Lấy GodHuman",_G.Auto_God_Human,function(value)
...
M:Toggle("Cày Radioactive Material",false,function(value)
Radioactive = value
...
M:Toggle("Cày Vampire Fang",false,function(value)
BjirVampire = value
...
M:Toggle("Cày vật chất kì dị",_G.AutoEctoplasm,function(value)
...
M:Toggle("Cày Mystic Droplet",false,function(value)
_G.Makori_gay = value
...
M:Toggle("Cày Magma Ore",_G.Makori_gay,function(value)
_G.Umm = value
StopTween(_G.Umm)
end)
...
M:Toggle("Cày Angel Wings",_G.Makori_gay,function(value)
_G.Auto_Wing = value
...
M:Toggle("Cày Leather",_G.Makori_gay,function(value)
_G.Leather = value
...
M:Toggle("Cày Scrap Metal",false,function(value)
Scrap = value
StopTween(Scrap)
end)
...
M:Toggle("Cày Conjured Cocoa",false,function(value)
Cocoafarm = value
StopTween(Cocoafarm)
end)
...
M:Toggle("Cày Dragon Scale",false,function(value)
Dragon_Scale = value
...
M:Toggle("Cày Gunpowder",false,function(value)
Gunpowder = value
StopTween(Gunpowder)
end)
...
M:Toggle("Cày Fish Tail Sea 3",false,function(value)
Fish = value
StopTween(Fish)
end)
...
M:Toggle("Cày Mini Tusk",false,function(value)
MiniHee = value
StopTween(MiniHee)
end)
...
Ss:Toggle("Tự động nâng chỉ số",_G.Auto_Stats_Kaitun,function(value)
...
Ss:Toggle("Cận chiến",false,function(Value)
melee = Value    
end)
Ss:Toggle("Máu",false,function(value)
defense = value
end)
Ss:Toggle("Kiếm",false,function(value)
sword = value
end)
Ss:Toggle("Súng",false,function(value)
gun = value
end)
Ss:Toggle("trái ác quỷ",false,function(value)
demonfruit = value
end)

PointStats = 5
Ss:Slider("Điểm",1,100,PointStats,nil,function(value)
PointStats = value
end)
...
if World1 or World2 then
    ...
    RaceV4:Toggle("Mua bánh răng",_G.Auto_Farm_Bone4,function(value)
    ...
    RaceV4:Toggle("Xoá xương trong ải", nil, function(value)
    ...
    RaceV4:Toggle("Nhìn trăng",_G.LockCamToMoon,function(value)
...
spawn(function()
    ...
    P:Toggle("Quan sát",false,function(value)
        SpectatePlys = value
    ...
    P:Toggle("Cày người chơi",false,function(value)
    ...
    P:Button("Nhận nhiệm vụ ngchơi",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PlayerHunter")
    end)
    
    P:Toggle("Làm nhiệm vụ kill ngchơi",false,function(value)
    ...
    P:Toggle("Ngắm Skill Súng",false,function(value)
        _G.Aimbot_Gun = value
    end)
    ...
    P:Toggle("Ngắm Skill",false,function(value)
    ...
    P:Toggle("bật Pvp",false,function(value)
        _G.EnabledPvP = value
    end)
    ...
    P:Toggle("An toàn",false,function(value)
        _G.Safe_Mode = value
...
T:Button("Đến sea 1",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
end)

T:Button("Đến sea 2",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
end)

T:Button("Đến sea 3",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
end)

T:Button("Đến thuỷ quái",function()
    for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
        if v:FindFirstChild("HumanoidRootPart") then
...
T:Toggle("Di chuyển",false,function(value)
...
T:Toggle("Di chuyển",_G.TeleportNPC,function(value)
...
R:Dropdown("Chọn Chips",Raidslist,function(value)
    _G.SelectChip = value
end)
...
R:Button("Vào tập kích",function()
    if World2 then
...
R:Toggle("Nâng V2",_G.Auto_Awakener,function(value)
...
if World2 then
    R:Button("Chổ tập kích",function()
...
R:Toggle("Lấy kiếm law", _G.AutoOderSword,function(value)
 _G.AutoOderSword = value
StopTween( _G.AutoOderSword)
end)

R:Toggle("Lấy Kiếm Law Hop", _G.AutoOderSwordHop,function(value)
...
R:Button("Mua chip tập kích law",function()
local args = {
   [1] = "BlackbeardReward",
   [2] = "Microchip",
   [3] = "2"
...
R:Button("Vào tập kích Law",function()
    if World2 then
...
S:Seperator("Abilities")
    ...
    S:Button("Mua Buso Haki [ $25,000 Beli ]",function()
    ...
    S:Button("Mua Observation Haki [ $750,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","Buy")
    end)
    
S:Toggle("Mua hết kĩ năng", false, function(t)
    Abilities = t
...
S:Seperator("Ã¢â€ºÂµ Boats Ã¢â€ºÂµ")
...
S:Dropdown("Chọn thuyền",BoatList,function(value)
    SelectBoat = value
end)

S:Button("Mua thuyền",function()
    ...
    S:Button("Mua Death Step | $5,000 Frag $5,000,000  ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
    end)
    
    S:Button("Mua Sharkman Karate | $5,000 Frag | $2,500,000  ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
    end)
    
    S:Button("Mua Electric Claw | $5,000 Frag | $3,000,000  ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
    end)
    
    S:Button("Mua Dragon Talon |$5,000 Frag | $3,000,000 B ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
    end)

    S:Button("Mua God Human | $5,000 Frag | $5,000,000  ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman")
    end)
    
    S:Button("Mua Sanguine Art | $5,000 Frag | $5,000,000  ",function()
    ...
    S:Toggle("Mua kiếm yama",_G.AutoYama,function(value)
        _G.AutoYama = value
    end)
    ...
    S:Seperator("Ã°Å¸â€œÅ  Fragments Ã°Å¸â€œÅ ")

S:Button("Hoàn Chỉ số", function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","2")
end)

S:Button("Đổi tộc", function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","1")
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","2")
end)
    --------------Accessories-----------------
    	S:Seperator("Ã¢Å¡â„¢Ã¯Â¸Â Accessories Ã¢Å¡â„¢Ã¯Â¸Â")
...
_G.SelectFruit = ""
D:Dropdown("Chọn trái",Table_DevilFruitSniper,function(value)
    _G.SelectFruit = value
end)

D:Toggle("Mua trái",_G.AutoBuyFruitSniper,function(value)
    _G.AutoBuyFruitSniper = value
end)

    D:Button("Kiểm tra trái đang bán VIP",function()
...
D:Button("Kiểm tra trái đang bán",function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Remotes = ReplicatedStorage.Remotes
...
D:Toggle("Ăn trái",_G.AutoEatFruit,function(value)
...
D:Toggle("Ăn trái HOP",_G.AutoEatFruitHop,function(value)
...
D:Toggle("Đổi trái",_G.Random_Auto,function(value)
...
D:Button("Đổi trái",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Cousin","Buy")
end)

    D:Button("Cửa hàng trái",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
    game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
end)

D:Toggle("Thả trái",_G.DropFruit,function(value)
    _G.DropFruit = value
end)
...
D:Toggle("Cất trái",_G.AutoStoreFruit,function(value)
...
D:Toggle("Gom trái",_G.Grabfruit,function(value)
_G.Grabfruit = value
end)
spawn(function()
        while wait(.1) do
...
D:Toggle("Nhặt trái",_G.Tweenfruit,function(value)
_G.Tweenfruit = value
...
spawn(function()
    ...
    D:Toggle("Gom trái dễ ban",_G.BringFruitBF,function(value)
...
Misc:Textbox("Nhập id máy chủ", true, function(value)
_G.Job = value
end)
...
Misc:Button("Mở của hàng trái",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
    game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
end)
...
Misc:Button("Mở màu haki",function()
...
Misc:Toggle("Ản chat", _G.chat, function(value)
_G.chat = value
...
Misc:Toggle("Ẩn leaderboard", _G.leaderboard, function(a)
_G.leaderboard = a
...
Misc:Toggle("Tối giản",false,function(value)
    if value == true then
...
Misc:Toggle("Haki Cầu Vòng",false,function(value)
    RainbowHaki = value
end)

Misc:Toggle("Kiếm Yoru cầu vòng",false,function(value)
    RainbowYoru = value
end)
...
Misc:Textbox("Khoá tiền", "Please Type", true, function(value)
_G.LockBeli = value
end)

Misc:Textbox("Khoá F tím", "Please Type", true, function(value)
_G.LockFragments = value
end)
Misc:Seperator("Hack")
Misc:Button("Mở khoá haki",function()
local Ability = "Buso"
...
Misc:Button("Mở khoá dịch chuyển",function()
local Ability = "Soru"
if type(Ability) == 'string' then
game:GetService("CollectionService"):AddTag(game.Players.LocalPlayer.Character,Ability)
elseif type(Ability) == 'table' then
...
Misc:Button("Mở khoá nhảy liên tục",function()
local Ability = "Geppo"
if type(Ability) == 'string' then
game:GetService("CollectionService"):AddTag(game.Players.LocalPlayer.Character,Ability)
elseif type(Ability) == 'table' then
...
Misc:Button("Mở khoá cổng",function()
...
Misc:Button("Zoom Xa", function()
    while wait() do
        game.Players.LocalPlayer.CameraMaxZoomDistance = 9223372036854718
        end
end)

Misc:Button("Hiện vật phẩm", function(value)
...
Misc:Button("Tàn hình",function()
    game:GetService("Players").LocalPlayer.Character.LowerTorso:Destroy()
end)

Misc:Button("Vật phẩm dịch chuyển",function()
...
Misc:Button("Nhập tất cả code",function()
...
Misc:Dropdown("Chọn code",{"NOOB_REFUND","SUB2GAMERROBOT_RESET1","Sub2UncleKizaru"},function(value)
    _G.CodeSelect = value
end)

Misc:Button("Nhập code đã chọn",function()
    game:GetService("ReplicatedStorage").Remotes.Redeem:InvokeServer(_G.CodeSelect)
end)

Misc:Seperator("State")

Misc:Dropdown("Cấp độ haki",{"State 0","State 1","State 2","State 3","State 4","State 5"},function(value)
...
Misc:Button("Xoá xương",function(qww)
game:GetService("Lighting").LightingLayers:Destroy()
game:GetService("Lighting").Sky:Destroy()
end)

Misc:Button("Trời luôn sáng",function()
...
Misc:Button("Mở khoá fps",function()
    setfpscap(120)
end)

Misc:Button("Làm giảm GPU", function()
...
Misc:Seperator("ESP MENU")

Misc:Toggle("Esp người",false,function(a)
    ESPPlayer = a
UpdatePlayerChams()
end)

Misc:Toggle("Esp rương",false,function(a)
    ChestESP = a
UpdateChestChams() 
end)

Misc:Toggle("Esp trái ác quỷ",false,function(a)
    DevilFruitESP = a
...
Misc:Toggle("Esp trái cây",RealFruitESP,function(a)
    RealFruitESP = a
UpdateRealFruitChams() 
end)

Misc:Toggle("Esp hoa",false,function(a)
    FlowerESP = a
UpdateFlowerChams() 
end)
spawn(function()
...
Misc:Toggle("Esp đảo",IslandESP,function(value)
    IslandESP = value
...
Misc:Toggle("Esp thuỷ quái", false, function(nec)
SeaESP = nec
end)


Misc:Toggle("Esp quái", false, function(nec)
MobESP = nec
end)
...
Misc:Toggle("Bật tộc",_G.AutoAgility,function(value)
...
Misc:Toggle("Soru vô hạn",getgenv().InfSoru,function(value)
...
Misc:Toggle("Xuyên tường",_G.NOCLIP,function(value)
    _G.NOCLIP = value
end)
...
Misc:Button("Xoá dung nham",function()
    for i,v in pairs(game.Workspace:GetDescendants()) do
        if v.Name == "Lava" then   
            v:Destroy()
        end
